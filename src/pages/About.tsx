  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-700">
                  Whether you've got time to grab an authentic coffee or dive into local culture, we'll guide you to experiences that'll make your colleagues jealous back home! ✈️
                </p>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-traveler-blue text-center mb-6">Why Choose Us? 🌟</h2>
